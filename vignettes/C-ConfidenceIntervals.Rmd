...
positive by multiplying its length by $1-\alpha_1$, where $\alpha_1$ is 
...
anopaPlot(w, ~ Difficulty) + 
            ...
            scale_x_discrete(limits = c("Easy", "Moderate", "Difficult")) #changer order
```

As you can see from this plot, Difficulty is very significant, and the most different
conditions are Moderate vs. Difficult.
